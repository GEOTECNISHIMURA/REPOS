...
// DLLのID
#define  DLLAPP_CONTER			1
#define  DLLAPP_CONTER_MODIF	2
#define  DLLAPP_CONTER_NEW  	3
#define  DLLAPP_CONTER_ONETANI 	4

/*-	タスクＩＤ			　　-*/
#define		TD_CONTER		L"CONTER"
#define		TD_NEW			L"NEW"
#define		TD_MODIF		L"MODIF"
#define		TD_ONETANI		L"ONETANI"
